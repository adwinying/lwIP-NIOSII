...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80001a8
SOPC_SYSID_FLAG += --sidp=0x80001a8
...
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/LwIP/inc
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/LwIP/inc/ipv4
...
ALT_CPPFLAGS += -DALT_LWIP
ALT_CPPFLAGS += -D__freertos__
